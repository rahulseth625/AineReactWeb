                ...
                <div className="list-group list-group-flush">
                    <div className="menu">
                        <a className="list-group-item list-group-item-action list-group-item-light p-3 glyphicon"
                            href="#!">
                            <svg className="module"stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 472 512"
                        ...
                        <a className="list-group-item list-group-item-action list-group-item-light p-3" href="#!">
                            <svg className="module" stroke="currentColor module" fill="currentColor" strokeWidth="5" viewBox="0 0 1024 1024"
                            ...
                            <div className="set margintop">Students</div>
                        </a>
                        <a className="list-group-item list-group-item-action list-group-item-light lineheight" href="#!">
                            <svg className="svgtop" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em"
                            ...
                            <div className="margintop">Lession Plan</div>
                        </a>
                        <a className="list-group-item list-group-item-action list-group-item-light p-3" href="#!">
                            <svg className="module" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024"
                                height="1em" width="5em" height="25" xmlns="http://www.w3.org/2000/svg" color="#216b82">
                            ...
                            <div className="set margintop">Settings</div>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div className="card input-card">
                                <div onClick={() =>
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title card-margin">upload</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
